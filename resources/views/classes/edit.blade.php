    ...
    <div class="container">
        ...
        <form action="{{ route('classes.update', $class->class_id) }}" method="POST">
            ...
            <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('class_id') is-invalid @enderror" id="class_id" name="class_id" value="{{ old('class_id', $class->class_id) }}" required autofocus>
                    @error('class_id')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('course_id') is-invalid @enderror" id="course_id" name="course_id" value="{{ old('course_id', $class->course_id) }}" required autofocus>
                    @error('course_id')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('attached_class_id') is-invalid @enderror" id="attached_class_id" name="attached_class_id" value="{{ old('attached_class_id, $class->attached_class_id') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('max_students') is-invalid @enderror" id="max_students" name="max_students" value="{{ old('max_students', $class->max_students) }}" min="1" max="50" required>
                    @error('max_students')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
